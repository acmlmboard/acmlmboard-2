...
for($i=0;$i<320;$i+=20) {
	...
	imagettftext($im,7,0, 1034, $i+14, $cwhite, "/var/sites/acmlmboard/board/gfx/verdana.ttf", (310-$i)/5);
...
imagettftext($im,7,0,7,30,$cwhite, "/var/sites/acmlmboard/board/gfx/verdana.ttf", "Activity stats for $n\n  bold: 8-day average\n  thin: daily postcount");

...
function sqr($x) { return $x; } //return ($x<128)?(128*pow($x/128.0,4.0)):(128*(1.0-pow(1.0-($x/128.0),4.0))); }
...
if( ($tblbg2&0xFF0000)>>16 > ($tblbg2&0xFF) ) $imgname="dc2baser";
else $imgname="dc2base";

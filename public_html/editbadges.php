...
'value' => checkvar('t','type'),
        ),
        'priority' => array(
          'title' => 'Priority',
          'type' => 'numeric',
          'length' => 3,
'value' => checkvar('t','priority'),
        ),
        'inherit' => array(
          'title' => 'Inherit from',
          'type' => 'numeric',
          'length' => 3,
'value' => checkvar('t','inherit'),
        ),
        'image' => array(
          'title' => 'Image',
          'type' => 'imgref',
'value' => checkvar('t','image'),
        ),
        'posttext' => array(
          'title' => 'Post Text',
          'type' => 'text',

...
if (!$misc['lockdowntext'])
	$misc['lockdowntext'] = "Access to the board has been restricted by the administration.<br />Please forgive any inconvenience caused and stand by until the underlying issues have been resolved.";

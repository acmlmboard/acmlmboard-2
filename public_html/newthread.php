...
";
	if (can_edit_forum_threads($fid) && !$announce)
		print "     <input type=\"checkbox\" name=close id=close value=1 " . (isset($_POST['close']) ? "checked" : "") . "><label for=close>Close thread</label>
" . "      <input type=\"checkbox\" name=stick id=stick value=1 " . (isset($_POST['stick']) ? "checked" : "") . "><label for=stick>Stick thread</label>
";
	print "    </td>
" . " </table>
" . "</form>

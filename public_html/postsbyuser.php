...
" . "<td class=\"b\" align=left>
    ";
		if (!(can_view_forum($t)))
			...
			$print.= "<a href=thread.php?id=$t[id]>$t[title]</a>";
		$print.= "
	</td>
...
if (isset($_GET[postsbyforum])) {
	...
	if ($id)
		pageheader("Posts by time of day from user $user[name]");
	else
		pageheader("Posts by time of day on the board");
}
else {

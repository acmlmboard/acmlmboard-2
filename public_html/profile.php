...
[i]Sample[/i] message.";
   ...
   $post['revision'] = $post['maxrevision'] = $post['id'] = $post['mood'] = $post['nosmile'] = $post['thread'] = $post['deleted'] = $post['nolayout'] = 0;
           ...
           $L[TBL1]>
             $L[TRh]>
               $L[TD2]><a href=\"forum.php?user=$user[id]\">View threads</a>
                       ...
                       ". ((!has_perm('create-pms') && has_perm('create-admin-pms'))? (user_has_perm('staff',$user['id'],$user['group_id']) ? "| <a href=\"sendprivate.php?uid=".$user['id']."\">Send private message</a>":""):"") ."

...
$user = array();
$user['regdate'] = $sql->query_result("SELECT MIN(`regdate`) FROM users");
$user['regdate'] = 1171853565;
$max = ceil(($sql->query_result("SELECT COUNT(*) FROM `posts`") + 1) / 5000) * 5000;
$alen = 30;
// $max				= 5500;

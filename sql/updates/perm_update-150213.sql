...
INSERT INTO `perm` (`id`, `title`, `description`, `permcat_id`, `permbind_id`) VALUES ('edit-user-title', 'Edit User Title', '', '3', '');
...
INSERT INTO `perm` (`id`, `title`, `description`, `permcat_id`, `permbind_id`) VALUES ('edit-user-customnickcolor', 'Edit User Custom Nick Color', '', '3', '');
...
INSERT INTO `perm` (`id`, `title`, `description`, `permcat_id`, `permbind_id`) VALUES ('edit-user-displayname', 'Edit User Displayname', '', '3', '');
